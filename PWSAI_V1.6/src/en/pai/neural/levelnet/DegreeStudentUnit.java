...
public class DegreeStudentUnit extends TrainingUnit {
	private Student student;
	private String level;
	private int year;
	public DegreeStudentUnit(Student student, String level, int year) {
	...
	public String getOutput() {
		return String.valueOf(getLevelInteger(student.getDegreeLevel())-getLevelInteger(level));
	}
